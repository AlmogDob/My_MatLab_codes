...
legend ('Trajectory of HW6','Trajectory of HW4','Trajectory of HW3','Starting Point','Target')
xlabel('X [km]')
ylabel('Y [km]')
zlabel('Z [km]')
...
legend('X of HW6','Y of HW6','Z of HW6','X of HW4','Y of HW4','Z of HW4','X of HW3','Y of HW3','Z of HW3')
title ('X, Y and Z vs. Time')
xlabel 'Time [sec]'
ylabel 'Distance [km]'
subtitle 'Dor Katz - 318301355'
%%
miss6_meter=norm([res6(end,1),res6(end,3),res6(end,5)])*10^3
missV6_cmsec=norm([res6(end,2),res6(end,4),res6(end,6)])*10^5
%%
...
DelV6=trapz(f_tot6)*10^3 %meter_sec
DelV4=trapz(f_tot4)*10^3 %meter_sec
DelV3=(trapz(f_tot3)+norm([res3(end,3),res3(end,4),res3(end,6)]))*10^3 %meter_sec
%%
figure(3)
plot(t6,fx6,'r');
hold on
...
ylim([-5,5]*10^-5)
legend('fx of HW6','fy of HW6','fz of HW6','Total f of HW6','fx of HW4','fy of HW4','fz of HW4','Total f of HW4','fx of HW3','fy of HW3','fz of HW3','Total f of HW3')
